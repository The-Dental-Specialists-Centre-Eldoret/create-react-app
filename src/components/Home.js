  ...
  return (
    <div>
      <section className="home-slider owl-carousel">
        <div className="slider-item" style={{backgroundImage: 'url("assets/images/bg_00.jpg")'}}>
          ...
          <div className="container">
            <div className="row slider-text align-items-center" data-scrollax-parent="true">
              <div className="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Ultra modern dental facility located in Eldoret.</h1>
                <p className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">We offer quality of specialized dental care services to our patients using contemporary equipment materials and techniques.</p>
              </div>
            </div>
          </div>
        </div>
        <div className="slider-item" style={{backgroundImage: 'url("assets/images/bg_2.jpg")'}}>
          ...
          <div className="container">
            <div className="row slider-text align-items-center" data-scrollax-parent="true">
              <div className="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Modern Dental clinic in a Calm and Relaxed Environment.</h1>
                <p className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">We offer quality of specialized dental care services to our patients using contemporary equipment materials and techniques.</p>
              </div>
            </div>
          </div>
        </div>
        <div className="slider-item" style={{backgroundImage: 'url("assets/images/bg_4.jpg")'}}>
          <div className="overlay" />
          <div className="container">
            <div className="row slider-text align-items-center" data-scrollax-parent="true">
              <div className="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
        ...
        <div className="slider-item" style={{backgroundImage: 'url("assets/images/bg_5.jpg")'}}>
          <div className="overlay" />
          <div className="container">
            <div className="row slider-text align-items-center" data-scrollax-parent="true">
              <div className="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Modern Dental clinic in a Calm and Relaxed Environment.</h1>
                <p className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">We offer quality of specialized dental care services to our patients using contemporary equipment materials and techniques.</p>
                {/* <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="contact.html" class="btn btn-primary px-4 py-3" data-toggle="modal" data-target="#modalRequest">Make an Appointment</a></p> */}
              </div>
            </div>
          </div>
        </div>
        <div className="slider-item" style={{backgroundImage: 'url("assets/images/bg_6.jpg")'}}>
          <div className="overlay" />
          <div className="container">
            <div className="row slider-text align-items-center" data-scrollax-parent="true">
              <div className="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
        ...
        <div className="slider-item" style={{backgroundImage: 'url("assets/images/bg_7.jpg")'}}>
          <div className="overlay" />
          <div className="container">
            <div className="row slider-text align-items-center" data-scrollax-parent="true">
              <div className="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Modern dental Clinic for Your Desired Perfect Smile</h1>
                <p className="mb-4">We offer quality of specialized dental care services to our patients using contemporary equipment materials and techniques.</p>
                {/*<p><a href="contact.html" class="btn btn-primary px-4 py-3" data-toggle="modal" data-target="#modalRequest">Make an Appointment</a></p>*/}
              </div>
            </div>
          </div>
        </div>
        <div className="slider-item" style={{backgroundImage: 'url("assets/images/bg_8.jpg")'}}>
          <div className="overlay" />
          <div className="container">
            <div className="row slider-text align-items-center" data-scrollax-parent="true">
              <div className="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Modern Achieve for Your Desired Perfect Smile</h1>
                <p className="mb-4">We offer quality of specialized dental care services to our patients using contemporary equipment materials and techniques.</p>
                {/*<p><a href="contact.html" class="btn btn-primary px-4 py-3" data-toggle="modal" data-target="#modalRequest">Make an Appointment</a></p>*/}
              </div>
            </div>
        ...
        <div className="container">
          <div className="row no-gutters">
            <div className="col-md-6 color-1 p-4">
              ...
              <p>Dental surgery center in a calm place</p>
              <span className="phone-number">0748 434345</span>
            </div>
      ...
      <section className="ftco-section ftco-services">
        ...
        <div className="container-wrap mt-5">
          <div className="row d-flex no-gutters">
            <div className="col-md-6 img" style={{backgroundImage: 'url(assets/images/about-2.jpg)'}}>
            </div>
      ...
      <section className="ftco-section">
        <div className="container">
          <div className="row justify-content-center mb-5 pb-5">
            <div className="col-md-7 text-center heading-section ftco-animate">
              <h2 className="mb-3">Meet Our Experience Specialists'</h2>
          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
              <div className="staff">
                <div className="img mb-4" style={{backgroundImage: 'url(assets/images/person_5.jpg)'}} />
            ...
            <div className="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
              <div className="staff">
                <div className="img mb-4" style={{backgroundImage: 'url(assets/images/person_6.jpg)'}} />
                <div className="info text-center">
            ...
            <div className="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
              <div className="staff">
                <div className="img mb-4" style={{backgroundImage: 'url(assets/images/person_7.jpg)'}} />
                <div className="info text-center">
            ...
            <div className="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
              <div className="staff">
                <div className="img mb-4" style={{backgroundImage: 'url(assets/images/person_8.jpg)'}} />
                <div className="info text-center">
